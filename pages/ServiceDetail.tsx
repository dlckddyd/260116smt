...
// --- 4. Instagram Marketing Detail (REVAMPED: Visual & Algorithm) ---
    ...
    return (
        <div className="bg-white">
             ...
             <section className="relative w-full h-[85vh] flex flex-col items-center justify-center overflow-hidden bg-black">
                 ...
                 {/* Floating 3D Elements (CSS Shapes) */}
                            ...
                            <div className="w-full lg:w-1/2 relative">
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    ...
                                    <div className="bg-white border-2 border-pink-100 rounded-[2rem] p-6 shadow-2xl relative z-10 transform -translate-x-8 translate-y-8">
                                        ...
                                        <div className="grid grid-cols-2 gap-2">
                                            <div className="aspect-square bg-pink-50 rounded-lg border border-pink-100 flex items-center justify-center"><Heart className="text-pink-400 w-6 h-6 fill-pink-400 animate-pulse"/></div>
                                            <div className="aspect-square bg-purple-50 rounded-lg border border-purple-100 flex items-center justify-center"><MessageCircle className="text-purple-400 w-6 h-6"/></div>
                    ...
                    <RevealOnScroll>
                        ...
                        <div className="bg-[#151515] border border-white/10 rounded-[3rem] p-8 md:p-14 shadow-2xl relative overflow-hidden group">
                            ...
                            <div className="flex flex-col md:flex-row items-end justify-between gap-12 relative z-10">
                                ...
                                {/* The Graph (Simple Bar/Line Hybrid) */}
